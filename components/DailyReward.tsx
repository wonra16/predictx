        ...
        <>
          ...
          >
            <div className="relative w-full max-w-md">
              ...
              <button
                onClick={onClose}
                className="absolute -top-2 -right-2 w-10 h-10 rounded-full bg-[#1a1f35] border border-white/10 flex items-center justify-center hover:border-cyan-500/50 transition-all z-10"
              >
                <X className="w-5 h-5 text-gray-400" />
              </button>

              {/* Content */}
              <div className="bg-[#0a0e1a] border-2 border-cyan-500/30 rounded-3xl p-8 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  >
                    <div className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl bg-gradient-to-r from-orange-500/20 to-red-500/20 border border-orange-500/30">
                      ...
                      <div className="text-6xl font-bold text-white">{streakDays}</div>
                    </div>
                  ...
                  >
                    ...
                    <div className="text-center">
                      <div className="text-5xl font-bold bg-gradient-to-r from-cyan-400 to-cyan-500 bg-clip-text text-transparent mb-1">
                        {rewardPoints}
                      </div>
